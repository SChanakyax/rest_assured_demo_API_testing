...
public class UsersTest {
    ...
    public void testStatus_code(){
        ...
        RestAssured.baseURI = "https://intelliapi-mockserver.herokuapp.com/tasks/";

            String response =RestAssured.given().param("Authorization","Bearer 5aa8220420419fd5890bb88a1767ed7cb1abc4412024bfff91513a40d6e19823")
                .param("App-Name","IntelliAPI")
                .param("Organization","MaxSoft")
